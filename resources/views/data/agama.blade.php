...
<div class="bg-gray-50 min-h-screen py-10 px-6">
    <div class="max-w-6xl mx-auto space-y-10">
        ...
        <div class="bg-gradient-to-r from-blue-700 to-blue-500 text-white p-8 rounded-2xl shadow-lg">
            <h1 class="text-3xl md:text-4xl font-extrabold mb-2">Data Demografi Berdasar Agama</h1>
            <p class="text-blue-100">Statistik agama penduduk Desa Mojomanis</p>
        </div>
...
document.addEventListener("DOMContentLoaded", function () {
    ...
    function renderChart(type) {
        Highcharts.chart('agamaChart', {
            chart: { type: type === 'pie' ? 'pie' : 'column' },
            title: { text: 'Distribusi Agama' },
