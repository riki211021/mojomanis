...
<div class="bg-white p-6 rounded-xl shadow max-w-lg mx-auto">
    <h1 class="text-xl font-bold mb-4">Tambah Pendidikan Ditempuh</h1>

    <form action="{{ route('admin.pendidikan_ditempuh.store') }}" method="POST">
        @csrf
        <div class="mb-4">
            <label class="block font-medium mb-1">Kode</label>
            <input type="text" name="kode" class="w-full border rounded px-3 py-2" placeholder="Contoh: 1">
        </div>
